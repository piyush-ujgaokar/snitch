...
export const addToCart=async (req,res)=>{
    ...
    const isProductAlreadyInCart=cart.items.some(item=>item.product.toString()===productId && item.varient.toString()===varientId)

    if(isProductAlreadyInCart){
        const quantityInCart=cart.items.find(item=>item.product.toString()===productId && item.varient.toString()===varientId).quantity
